...
*/
    ...
    ScrollTrigger_ScrollTrigger.version = "3.12.4";
    ...
    function defaultScrollTrigger(section, showMarkers = false) {
        const object = {
            trigger: section,
            start: "+=30% center",
            end: "bottom top"
        };
        if (showMarkers) object.markers = true;
        return object;
    }
    setTimeout((function() {
        document.querySelector(".wrapper").classList.add("add_background");
    }), 1e3);
    document.addEventListener("DOMContentLoaded", (function() {
        function animateHeader() {
            ...
            const headerMenu = header.querySelectorAll(".menu li");
            const headerButton = header.querySelector(".actions .button");
            ...
            tl.from(header, {}).from(headerLogo, {
                scale: 0,
                duration: 1
            }).from(headerMenu, {
                stagger: .25
        ...
        function animateFirstScreen() {
            ...
            const backgroundImage = section.querySelector(".image_box");
            const title = section.querySelector("h1");
            const subTitle = section.querySelector(".header_box__above_title");
            const text = section.querySelector(".header_box__text");
        ...
        animateFirstScreen();
        function animateAdvantagesBlock() {
            const section = document.querySelector("section.advantages");
            if (!section) return false;
            const sectionTitle = section.querySelector(".header_box__title");
            const sectionSubtitle = section.querySelector(".header_box__above_title");
            const sectionText = section.querySelectorAll(".header_box__text p");
            const sectionButton = section.querySelectorAll(".button");
            const sectionImage = section.querySelector(".content_image");
            const sectionDecor = section.querySelector(".decor_image");
            const tl = gsapWithCSS.timeline({
        ...
        animateAdvantagesBlock();
        function animateChooseUsBlock() {
            const section = document.querySelector("section.choose_us");
            if (!section) return false;
            const sectionTitle = section.querySelector(".header_box__title");
            const sectionSubtitle = section.querySelector(".header_box__above_title");
            const sectionText = section.querySelectorAll(".header_box__text p");
        ...
        animateChooseUsBlock();
        function animateBlendsBlock() {
            const section = document.querySelector("section.blends");
            if (!section) return false;
            const sectionTitle = section.querySelector(".header_box__title");
            const cards = section.querySelectorAll(".slide");
            const sliderControls = section.querySelector(".swiper_control");
            const sliderBullets = section.querySelector(".swiper-pagination");
            const tl = gsapWithCSS.timeline({
                scrollTrigger: defaultScrollTrigger(section),
                defaults: {
                    opacity: 0,
            ...
            tl.from(sectionTitle, {}).from(cards, {
                y: 50,
                stagger: .25
            }, "<25%").from(sliderControls, {}, "<50%").from(sliderBullets, {
                y: 25
            }, "<");
        }
        animateBlendsBlock();
        function animateBestMenuBlock() {
            const section = document.querySelector("section.best_menu");
            if (!section) return false;
            const sectionTitle = section.querySelector(".header_box__title");
            const sectionSubtitle = section.querySelector(".header_box__above_title");
            const sectionDecor = section.querySelector(".decor_image img");
            const sectionMenuList = section.querySelectorAll(".list__item");
            const sectionImage = section.querySelectorAll(".image_side");
            setStyleForMenuList();
            setTimeout((function() {
                const tl = gsapWithCSS.timeline({
                    scrollTrigger: defaultScrollTrigger(section),
            ...
            function animateList() {
                sectionMenuList.forEach((function(item, index) {
                    const menuTl = gsapWithCSS.timeline({
                        defaults: {
                            duration: 1,
                            opacity: 1
                        }
                    }), nameTitle = item.querySelector(".name"), price = item.querySelector(".price_box"), decor = item.querySelector(".decor"), description = item.querySelector(".description");
                    menuTl.to(nameTitle, {
                        y: 0,
                        delay: () => index * .35
                    }).to(decor, {
                        "--width": "100%"
                    }, "<50%").to(price, {}, "<50%").to(description, {
                        x: 0
                    }, "<");
                }));
            }
            function setStyleForMenuList() {
                const menuName = section.querySelectorAll(".name");
                const menuPrice = section.querySelectorAll(".price_box");
                const menuDescription = section.querySelectorAll(".description");
                gsapWithCSS.set(menuName, {
                    opacity: 0,
                    y: 50
                });
                gsapWithCSS.set(menuPrice, {
                    opacity: 0
                });
                gsapWithCSS.set(menuDescription, {
                    opacity: 0,
                    x: -50
                });
            }
        }
        animateBestMenuBlock();
        function animateSometimesBlock() {
            const section = document.querySelector("section.sometimes");
            if (!section) return false;
            const sectionTitle = section.querySelector(".header_box__title");
            const images = section.querySelectorAll(".image");
            const listItem = section.querySelectorAll(".list__item");
            const imageDecor = section.querySelectorAll(".decor_image img");
            setStyleForList();
            setTimeout((function() {
                const tl = gsapWithCSS.timeline({
                    scrollTrigger: defaultScrollTrigger(section),
                ...
                tl.from(sectionTitle, {}).from(images, {
                    x: -50,
                    stagger: .5
                }).add(animateList).from(imageDecor, {
                    xPercent: -10
                });
            }), 500);
            function animateList() {
                listItem.forEach((function(item, index) {
                    const listTl = gsapWithCSS.timeline({
                        defaults: {
                            duration: .5,
                            opacity: 1
                        }
                    }), nameTitle = item.querySelector(".list__title"), description = item.querySelector(".list__description");
                    listTl.to(nameTitle, {
                        y: 0,
                        delay: () => index * .35
                    }).to(description, {
            ...
            function setStyleForList() {
                const listTitle = section.querySelectorAll(".list__title");
                const listDescription = section.querySelectorAll(".list__description");
                gsapWithCSS.set(listTitle, {
                    opacity: 0,
                    y: 50
                });
                gsapWithCSS.set(listDescription, {
                    opacity: 0,
                    x: -50
                });
            }
        }
        animateSometimesBlock();
        function animateBestSellerBlock() {
            const section = document.querySelector("section.best_seller");
            if (!section) return false;
            const sectionTitle = section.querySelector(".header_box__title");
            const sectionSubtitle = section.querySelector(".header_box__above_title");
            const bodyContent = section.querySelector(".best_seller__body");
            const columns = section.querySelectorAll(".list");
            const productImage = section.querySelectorAll(".product_image");
            setStyleForColumns();
            setTimeout((function() {
                const tl = gsapWithCSS.timeline({
                    scrollTrigger: {
                ...
                const tlForColumns = gsapWithCSS.timeline({
                    scrollTrigger: {
                        trigger: bodyContent,
                        start: "top center"
                    }
                ...
                tlForColumns.from(bodyContent, {
                    xPercent: -100,
                    duration: 1
                }).add(animateColumns).from(productImage, {
                    opacity: 0,
                    yPercent: 10
                }, ">50%");
            }), 500);
            function animateColumns() {
                columns.forEach((function(column) {
                    const items = column.querySelectorAll(".list__item");
                    items.forEach((function(item, index) {
                        const icon = item.querySelector(".list__icon");
                        const title = item.querySelector(".list__title");
                        const eachItemTimeLine = gsapWithCSS.timeline({
                            defaults: {
                                opacity: 1,
                                y: 0,
                                duration: 1,
                        ...
                        eachItemTimeLine.to(icon, {
                            delay: () => index * .45
                        }).to(title, {}, "<20%");
                    }));
                }));
            }
            function setStyleForColumns() {
                const icon = section.querySelectorAll(".list__icon");
                const title = section.querySelectorAll(".list__title");
        ...
        animateBestSellerBlock();
        function animateGalleryBlock() {
            const section = document.querySelector("section.our_gallery");
            if (!section) return false;
            const sectionTitle = section.querySelector(".header_box__title");
            const sectionSubtitle = section.querySelector(".header_box__above_title");
            const sectionButton = section.querySelector(".button");
            const firstBigImage = section.querySelector(".image_top");
            const mediumImagesBox = section.querySelector(".images_medium");
            const secondBigImages = section.querySelectorAll(".img_box");
            const decorImage_1 = section.querySelector(".decor--1 img");
            const decorImage_2 = section.querySelector(".decor--2 img");
            const decorImage_3 = section.querySelector(".decor--3 img");
            const decorImage_4 = section.querySelector(".decor--4 img");
            const slideImagesParent = section.querySelector(".photo_gallery");
            const slideImages = section.querySelectorAll(".slide-content");
            setTimeout((function() {
                const tl = gsapWithCSS.timeline({
                    scrollTrigger: {
                        trigger: section,
                ...
                const firstBigImageTimeline = gsapWithCSS.timeline({
                    scrollTrigger: {
                        trigger: firstBigImage,
                        start: "+=20% +=90%"
                    },
                    defaults: {
                        opacity: 0,
                ...
                const secondBigImagesTimeline = gsapWithCSS.timeline({
                    scrollTrigger: {
                        trigger: mediumImagesBox,
                        start: "+=30% +=90%"
                    },
                    defaults: {
                        opacity: 0,
                ...
                const galleryTimeline = gsapWithCSS.timeline({
                    scrollTrigger: {
                        trigger: slideImagesParent,
                        start: "+=30% +=90%"
                    },
                    defaults: {
                        opacity: 0,
                ...
                tl.from(sectionTitle, {}).from(sectionSubtitle, {
                    y: -50
                }, "-=90%").from(sectionButton, {}, "<50%");
                firstBigImageTimeline.from(firstBigImage, {}).from(decorImage_1, {
                    xPercent: -10
                }).from(decorImage_2, {
                    xPercent: 10
                }, "<");
                secondBigImagesTimeline.from(secondBigImages, {
                    yPercent: 10,
                    stagger: .25
                }).from(decorImage_3, {
                    xPercent: 10
                ...
                galleryTimeline.from(slideImages, {
                    yPercent: 15,
                    stagger: .35
                });
            }), 500);
        ...
        function animateFooter() {
            ...
            if (!section) return false;
            const logo = section.querySelector(".center_side svg");
            const logoBox = section.querySelector(".center_side");
            const socialIcons = section.querySelectorAll(".footer__medium a");
            const sideInfo = section.querySelectorAll(".side");
            const footerBottom = section.querySelector(".footer__bottom");
            const footerBottomText = section.querySelector(".footer__bottom p");
            setTimeout((function() {
                const tl = gsapWithCSS.timeline({
                    scrollTrigger: {
                        trigger: section,
                ...
                tl.from(logo, {
                    ...
                    "--height": "100%",
                    opacity: 1
                }, "<50%").from(sideInfo, {}, "-=80%").to(footerBottom, {
                    "--width": "100%",
                    opacity: 1,
                    ease: "none"
                }, "-=80%").from(footerBottomText, {}, "-=50%");
            }), 500);
        }
        animateFooter();
    }));
    ...
    isWebp();
    function runCodeAfterWindowSizeCheck(breakpoint, runYourFunctionIfWindowSize_IsMatches, runYourFunctionIfWindowSize_IsNotMatches) {
        window.addEventListener("load", (function() {
            checkBreakpoint();
            const windowSize = window.matchMedia(breakpoint);
            //!run code (page is load)
                        handleWindow();
            if (windowSize.addEventListener) windowSize.addEventListener("change", handleWindow); //!run code (if window size is change)
             else if (windowSize.addListener) windowSize.addListener(handleWindow);
 //!run code (if window size is change)
                        function checkBreakpoint() {
                if (breakpoint.includes("max-width") || breakpoint.includes("min-width")) return breakpoint; else breakpoint = "(max-width: 990px)";
            }
            function handleWindow() {
                if (windowSize.matches) {
                    if (runYourFunctionIfWindowSize_IsMatches && runYourFunctionIfWindowSize_IsMatches !== "") runYourFunctionIfWindowSize_IsMatches();
                } else if (runYourFunctionIfWindowSize_IsNotMatches && runYourFunctionIfWindowSize_IsNotMatches !== "") runYourFunctionIfWindowSize_IsNotMatches();
            }
        }));
    }
    ...
    function burgerMenu() {
        ...
        function closeBurger() {
            if (burgerBtn.classList.contains("active_burger")) burgerBtn.click();
        }
        runCodeAfterWindowSizeCheck("(max-width:1100px)", "", closeBurger);
    }
    burgerMenu();
    function listenerForScroll() {
        ...
        window.addEventListener("scroll", (function() {
            ...
            if (currentScrollTop > lastScrollTop) {
                ...
                header.classList.add("smaller_for_scroll");
            } else {
                header.classList.remove("hidden_header");
                if (currentScrollTop < 50) header.classList.remove("smaller_for_scroll");
            }
    ...
    function blendsSlider() {
        const blendsSection = document.querySelector(".blends");
        if (!blendsSection) return false;
        const slider = blendsSection.querySelector(".swiper");
        new Swiper(slider, {
            ...
            navigation: {
                nextEl: blendsSection.querySelector(".swiper-button-next"),
                prevEl: blendsSection.querySelector(".swiper-button-prev")
            },
            pagination: {
                el: blendsSection.querySelector(".swiper-pagination")
            },
            breakpoints: {
                768: {
                    slidesPerView: 2.5,
